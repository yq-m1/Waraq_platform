...
// Top-3 get distinctive medal colours; the rest get a muted badge
...
function RankedCard({
  ...
  return (
    ...
    >
      ...
      {/* Info */}
      <div className="p-3">
        <h3 className="font-bold text-white/90 text-xs leading-snug line-clamp-2 mb-2 group-hover:text-amber-200 transition-colors"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {books.map((book, i) => (
            ...
            >
              <RankedCard book={book} rank={i + 1} onClick={onBookClick} />
            </div>
          ))}
        </div>
