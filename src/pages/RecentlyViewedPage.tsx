...
import { Clock, Loader2, ArrowLeft, ArrowRight } from 'lucide-react';
...
export default function RecentlyViewedPage({ onBack, onBookClick, onOpenAuth }: Props) {
    ...
    <div className="min-h-screen bg-stone-50">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8" dir={t.dir}>
          <div className="pt-20 pb-10">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl sm:text-3xl font-bold text-white">{t.profile.recently_viewed}</h1>
                {!loading && (
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 pb-20">
        {!user ? (
          ...
          <EmptyState icon={Clock} message={t.profile.no_recently_viewed} />
        ) : (
